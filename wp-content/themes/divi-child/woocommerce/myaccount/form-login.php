...
<?php endif; ?>
		...
		<div class="mwf-social-login-wrapper">
		    <?php 
		    if (class_exists('MWF_Social_Auth')) {
		        $social_auth = new MWF_Social_Auth();
		        echo $social_auth->render_social_buttons();
		    }
		    ?>
		    <div class="mwf-social-divider">
		        <span><?php esc_html_e('or login with email', 'woocommerce'); ?></span>
		    </div>
		</div>
