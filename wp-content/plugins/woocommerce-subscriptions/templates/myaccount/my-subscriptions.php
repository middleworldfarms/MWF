...
<div class="woocommerce_account_subscriptions">
	...
	<?php endforeach; ?>
		...
		<?php endif; ?>
	<?php else : ?>
		<div class="no_subscriptions woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info" style="background: #f0f8ff; border-left: 4px solid #96588a; padding: 30px; text-align: center;">
			<?php if ( 1 < $current_page ) :
				...
				<p style="font-size: 18px; margin-bottom: 20px; color: #333;">
					<?php esc_html_e( 'You have no active subscriptions.', 'woocommerce-subscriptions' ); ?>
				</p>
				<a class="woocommerce-Button button" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>" style="display: inline-block; padding: 15px 40px; background-color: #96588a; color: #ffffff !important; font-size: 18px; font-weight: bold; text-decoration: none; border-radius: 5px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: all 0.3s ease;">
