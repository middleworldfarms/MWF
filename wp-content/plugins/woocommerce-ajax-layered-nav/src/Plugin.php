...
class Plugin {
	...
	private function define_constants() {
		$this->define( 'WC_AJAX_LAYERED_NAV_VERSION', '2.1.0' );
	...
	public function declare_compatibility() {
		...
		if ( class_exists( '\Automattic\WooCommerce\Utilities\FeaturesUtil' ) ) {
			...
			\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'cart_checkout_blocks', WC_AJAX_LAYERED_NAV_FILE, true );
		}
	}
