<?php
/**
 * Render addons page under styler for WPForms.
 */
class Sfwf_Addons_Page {
	...
	/**
	 * Register add-on menu under styler wpforms in WordPress Dashboard.
	 *
	 * @return void
	 */
	...
	/**
	 * Render the HTML of add-on page.
	 *
	 * @return void
	 */
	public function show_addons() {
		...
		<img src="<?php echo esc_url( SFWF_URL ); ?>/css/images/addons/bootstrap.png">
		...
		<div class="sfwf-extend sfwf-box">
		<img src="<?php echo esc_url( SFWF_URL ); ?>/css/images/addons/field-icons.png">
		<div class="sfwf-extend-content">
		<h5>Field Icons</h5>
		...
		<img src="<?php echo esc_url( SFWF_URL ); ?>/css/images/addons/tooltips.png">
		<div class="sfwf-extend-content">
		<h5>Tooltips</h5>
		...
		<div class="sfwf-extend sfwf-box" style="float: none;margin: 10px auto;">
			<img src="<?php echo esc_url( SFWF_URL ); ?>/css/images/addons/views.png">
			<div class="sfwf-extend-content">
...
add_action( 'plugins_loaded', 'sfwf_initialize_addons_page' );

/**
 * Initialize addon page.
 *
 * @return void
 */
function sfwf_initialize_addons_page() {
