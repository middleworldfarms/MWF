<?php
/**
 * The layout and functionality of Welcome Page.
 */
class Sfwf_Welcome_Page {

	/**
	 * Execulte all the actions and filters.
	 */
	...
	/**
	 * Register menu page under WordPress Dashboard.
	 *
	 * @return void
	 */
	...
	/**
	 * HTML of welocme page.
	 *
	 * @return void
	 */
	public function sfwf_show_documentation() {
		?>

	<div class="sfwf-welcome-wrapper">
		<div class="sfwf-about-section sfwf-section">
			<div class="sfwf-left-logo-cont">
				<img src="<?php echo esc_url( SFWF_URL ) . '/admin-menu/images/icon.png'; ?>">
			</div>
		...
		<div class="sfwf-usage-section sfwf-section-spacing">
			<div class="sfwf-usage-text sfwf-center-text sfwf-section">
				...
				<div class="sfwf-video-section">
					...
					<img class="" src="<?php echo esc_url( SFWF_URL ) . '/admin-menu/images/video-banner.png'; ?>" />
					</a>
				</div>
		</div>
		<div class="sfwf-feature-section sfwf-section sfwf-section-spacing">
			...
			<div class="sfwf-feature-info-container">
				<div class="sfwf-left-half">
					<img src="<?php echo esc_url( SFWF_URL ) . '/css/images/welcome/welcome-feature.png'; ?>" />
				...
				<div class="sfwf-right-half">
						<img src="<?php echo esc_url( SFWF_URL ) . '/css/images/welcome/easy-to-use.png'; ?>" />
						<h5>Easy to Use</h5>
						<p>Easy to use controls like color picker, range slider and ability to give values in px, %, rem, em etc.</p>
				</div>
				<div class="sfwf-left-half">
						<img src="<?php echo esc_url( SFWF_URL ) . '/css/images/welcome/flexible.png'; ?>" />
						<h5>Flexible</h5>
						<p>Multiple settings for each field type to create the design you want to have.</p>
				</div>
				<div class="sfwf-right-half">
						<img src="<?php echo esc_url( SFWF_URL ) . '/css/images/welcome/customer-service.png'; ?>" />
				...
				<div class="sfwf-left-half">
						<img src="<?php echo esc_url( SFWF_URL ) . '/css/images/welcome/addons.png'; ?>" />
				...
				<div class="sfwf-right-half">
						<img src="<?php echo esc_url( SFWF_URL ) . '/css/images/welcome/bootstrap.png'; ?>" />
				...
				<div class="sfwf-left-half">
						<img src="<?php echo esc_url( SFWF_URL ) . '/css/images/welcome/field-icons.png'; ?>" />
				...
				<div class="sfwf-right-half">
						<img src="<?php echo esc_url( SFWF_URL ) . '/css/images/welcome/tooltip.png'; ?>" />
		...
		<div class="sfwf-support-section sfwf-section-spacing" style="background-image: url(<?php echo esc_url( SFWF_URL ) . '/admin-menu/images/support.png'; ?>)">
